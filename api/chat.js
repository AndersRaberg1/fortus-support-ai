...
console.log('Backend loaded – starting setup'); // Log vid fil-load för att se om syntax OK
...
module.exports = async (req, res) => {
  console.log('API invoked – method:', req.method, 'body:', req.body); // Log vid invocation
  if (req.method !== 'POST') {
